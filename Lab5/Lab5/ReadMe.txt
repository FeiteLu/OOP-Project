...
Feite developed the majority of the code with the first few stages we both developed the later stages in conjunction through zoom feite did some of the work on his own later and we ended up debugging the code in zoom together. Klein did a majority commenting with the help of feite in zoom. 
